...
\centering
\begin{minipage}{0.38\linewidth}\centering\qrcode[height=5.5cm,version=4]{https://github.com/robotson/lakota-translation-benchmark}\end{minipage}\hfill
\begin{minipage}{0.58\linewidth}\raggedright
{\headfont\bfseries Aggregated results and eval harness code}\\[1pt]
{\footnotesize (language data withheld from open web)}\\[10pt]
