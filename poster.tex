...
% Tufte sparkline: 3-point mini-slope at shared y-scale (0–100); compact for table cells
\newcommand{\sparkline}[3]{%
  \begin{tikzpicture}[x=0.20cm,y=0.0085cm,baseline=2pt]
    \draw[steel,line width=0.7pt] (0,#1) -- (4,#2) -- (8,#3);
    \fill[steel] (0,#1) circle (1.1pt);
    \fill[steel] (4,#2) circle (1.1pt);
    \fill[steel] (8,#3) circle (1.1pt);
  \end{tikzpicture}%
}
...
\begin{block}{Phrasebook concentration (L\,$\rightarrow$\,E chrF++)}
\centering\small
\begin{tabular}{@{}lccccl@{}}
\toprule
\textbf{Model} & \textbf{Sc.\,4} & \textbf{Sc.\,5} & \textbf{Sc.\,6} & \textbf{$\Delta$} & \textbf{trend} \\
\midrule
Gemini 3.1 Pro & 52.7 & 58.2 & \textbf{81.9} & +29.2 & \sparkline{52.7}{58.2}{81.9} \\
Claude Opus 4.6 & 41.6 & 41.0 & 65.6 & +24.0 & \sparkline{41.6}{41.0}{65.6} \\
Claude Sonnet 4.6 & 40.3 & 45.1 & 64.1 & +23.8 & \sparkline{40.3}{45.1}{64.1} \\
DeepSeek-V4-Pro & 33.0 & 33.9 & 59.6 & +26.6 & \sparkline{33.0}{33.9}{59.6} \\
GPT-5.2 & 27.9 & 23.7 & 45.7 & +17.8 & \sparkline{27.9}{23.7}{45.7} \\
Qwen3.6-Plus & 23.3 & 22.1 & 41.7 & +18.4 & \sparkline{23.3}{22.1}{41.7} \\
GLM-5.1 & 27.3 & 26.0 & 41.0 & +13.7 & \sparkline{27.3}{26.0}{41.0} \\
\bottomrule
\end{tabular}
\\[8pt]
{\footnotesize Score 4 = more formal/complex, 6 = most conversational (NLD curation tier). Every model lifts sharply at 6: performance concentrates on high-frequency phrasebook-like items rather than reflecting general capability. Sparklines share a 0--100 y-axis, so row height encodes absolute score.}
\end{block}
\end{column}
\begin{column}{0.49\textwidth}
